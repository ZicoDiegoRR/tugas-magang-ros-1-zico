...
(cl:defmethod cl:initialize-instance :after ((m <ops>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ops)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name Bank-msg:<ops> is deprecated: use Bank-msg:ops instead.")))

(cl:ensure-generic-function 'selection-val :lambda-list '(m))
(cl:defmethod selection-val ((m <ops>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Bank-msg:selection-val is deprecated.  Use Bank-msg:selection instead.")
  (selection m))

(cl:ensure-generic-function 'money-val :lambda-list '(m))
(cl:defmethod money-val ((m <ops>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Bank-msg:money-val is deprecated.  Use Bank-msg:money instead.")
  (money m))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <ops>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Bank-msg:id-val is deprecated.  Use Bank-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <ops>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Bank-msg:name-val is deprecated.  Use Bank-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'get_display-val :lambda-list '(m))
(cl:defmethod get_display-val ((m <ops>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Bank-msg:get_display-val is deprecated.  Use Bank-msg:get_display instead.")
  (get_display m))
